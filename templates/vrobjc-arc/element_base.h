...
@property (nonatomic, strong) NSMutableDictionary * originalValues;
<% end %>
<%
	for k,v in pairs(this.attributes) do
	...
	if (this.mixedContent == true) then
		gaxb_print("@property (nonatomic, strong) NSString *MixedContent;\n@property (nonatomic) BOOL MixedContentExists;\n");
	end
%>
<%
    local wereSequences = false;
	for k,v in pairs(this.sequences) do
        wereSequences = true;
		if (v.name == "any") then
			gaxb_print("@property (nonatomic,strong) NSMutableArray * anys;\n")
		elseif(isPlural(v)) then
			gaxb_print("@property (nonatomic,strong) NSMutableArray * "..pluralName(v.name)..";\n")
		else
			gaxb_print("@property (nonatomic"..(isObject(v)==true and ", strong" or "")..") "..typeForItem(v).." "..v.name..";\n")
			gaxb_print("@property (nonatomic) BOOL "..v.name.."Exists;\n")
		end
	end
    if (wereSequences) then
        gaxb_print("\n@property (nonatomic, strong) NSDictionary * elementsTagNamesMampForAppending;\n")
    end
%>
<%
	for k,v in pairs(this.attributes) do
...
- (NSString *) xmlns;
@property (nonatomic, strong) NSString * xmlnsForAppending;
@property (nonatomic, strong) NSString * tagNameForAppending;
